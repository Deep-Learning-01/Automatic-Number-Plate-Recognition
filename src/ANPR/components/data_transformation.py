...
from src.ANPR.entity.config_entity import DataTransformationConfig
...
class DataTransformation:
    ...
    def data_preprocessing(self,labels_dataframe, image_path_list):
        ...
        Description :   In this method using OpenCV we will convert each image into an array &
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifacts:
        try: 
            ...
            #successfully extracted the diagonal position of each image and convert the data from an unstructured to a structured format
